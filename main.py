...
class ImageToPDFConverter:
    ...
    def convert_images_to_pdf(self):
        ...
        output_pdf_paths = self.output_pdf_name.get() + ".pdf" if self.output_pdf_name.get() else "output.pdf"

        pdf = canvas.Canvas(output_pdf_paths, pagesize=(612, 792))
